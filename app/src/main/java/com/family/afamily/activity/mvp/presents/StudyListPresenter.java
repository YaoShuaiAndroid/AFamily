...
public class StudyListPresenter extends BasePresent<StudyListView> {
    public StudyListPresenter(StudyListView view) {
        attach(view);
    }
    ...
    public void getData(String token, String cat_id, String sort, String order, int page, final int getType,
                        final List<Map<String, String>> list, final SuperRecyclerView recyclerView, final StudyListAdapter adapter) {
        if (getType == 1) {
            view.showProgress(3);
        }
