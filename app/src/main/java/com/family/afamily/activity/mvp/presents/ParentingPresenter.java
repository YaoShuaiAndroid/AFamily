...
public class ParentingPresenter extends BasePresent<InnateDetailView> {

    public ParentingPresenter(InnateDetailView view) {
        attach(view);
    }
    ...
    public void getData(String conmmentId,int page, final int type) {
        ...
        OkHttpClientManager.postAsyn(UrlUtils.detailsGuide, new OkHttpClientManager.ResultCallback<ResponseBean<BasePageBean<CommentModel>>>() {
            @Override
    ...
    public void submitLike(String conmmentId,String token) {
        ...
        params = Utils.getParams(params);
        OkHttpClientManager.postAsyn(UrlUtils.earlyGuideLike, new OkHttpClientManager.ResultCallback<ResponseBean<BasePageBean<CommentModel>>>() {
            @Override
            public void onError(Request request, Exception e) {
                view.hideProgress();
                view.submitLike(0);
    ...
    public void detailsFacultys(String conmmentId,String user_id) {
        ...
        params = Utils.getParams(params);
        OkHttpClientManager.postAsyn(UrlUtils.detailsGuides, new OkHttpClientManager.ResultCallback<ResponseBean<InnateIntelligenceModel>>() {
            @Override
            public void onError(Request request, Exception e) {
                view.hideProgress();
            }
    ...
    public void earlyFacultyComment(String conmmentId,String token,String content,String comid) {
        ...
        params = Utils.getParams(params);
        OkHttpClientManager.postAsyn(UrlUtils.earlyGuideComment, new OkHttpClientManager.ResultCallback<ResponseBean<CommentModel>>() {
            @Override
            public void onError(Request request, Exception e) {
                view.hideProgress();
            }
