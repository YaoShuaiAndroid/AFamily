...
public class InnateDetailActivity extends BaseActivity<InnateDetailPresenter> implements SuperRecyclerView.LoadingListener,InnateDetailView {
    ...
    @Override
    public InnateDetailPresenter initPresenter() {
        return new InnateDetailPresenter(this);
    }
    ...
    public void successDetailData(InnateIntelligenceModel data) {
        ...
        if(data.getLike()!=null&&data.getLike().equals("1")){
            ...
            innateDetailLikeNum.setText(data.getLikes());
