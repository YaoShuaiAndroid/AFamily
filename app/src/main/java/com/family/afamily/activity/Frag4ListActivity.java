...
import com.family.afamily.activity.mvp.presents.Frag4ListPresenter;
...
public class Frag4ListActivity extends BaseActivity<Frag4ListPresenter> implements StudyListView, SuperRecyclerView.LoadingListener {
    ...
    private Frag4ListAdapter adapter;
    ...
    @Override
    public Frag4ListPresenter initPresenter() {
        return new Frag4ListPresenter(this);
    }
    ...
    public void initDataAsync() {
        ...
        adapter = new Frag4ListAdapter(mActivity, list);
