...
import com.family.afamily.activity.MainActivity;
...
/**
 * Created by hp2015-7 on 2017/9/15.
 */
...
public class OkHttpClientManager {
    ...
    private void _postAsyn(String url, ResultCallback callback, File[] files, String[] fileKeys, Map<String, String> params) throws IOException {
        Request request = buildMultipartFormRequest(url, files, fileKeys, map2Params(params));
        deliveryResult(callback, request);
    }
    ...
    private void _postAsyn(String url, ResultCallback callback, File file, String fileKey, Map<String, String> params) throws IOException {
        Request request = buildMultipartFormRequest(url, new File[]{file}, new String[]{fileKey}, map2Params(params));
        deliveryResult(callback, request);
    }
            ...
            public void onResponse(final Response response) {
                try {
                    ...
                    if (callback.mType == String.class) {
                        ...
                        L.e("tag", string);
                        Log.e(string);
                        ResponseBean ben = mGson.fromJson(string, ResponseBean.class);
                        if (ben.getRet_code() == -1) {
                            Context context = MyApplication.getInstance().getApplicationContext();
                            Intent mIntent = new Intent(MainActivity.ACTION_KILL_ALL_ACTIVITY);
                            mIntent.putExtra("msg",ben.getMsg());
                            //发送广播
